...
from KHContigFilterApp.KHContigFilterAppImpl import KHContigFilterApp
from KHContigFilterApp.KHContigFilterAppServer import MethodContext
...
class KHContigFilterAppTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('KHContigFilterApp'):
        ...
        cls.serviceImpl = KHContigFilterApp(cls.cfg)
